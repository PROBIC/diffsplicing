...
#
source("MH.R")
mcmc_filenames_in=list("t5_r1.rpkm_gene","t5_r2.rpkm_gene","t5_r3.rpkm_gene")
noLines=3811
G=6
no_iter=1000
noSkip=0
MH(mcmc_filenames_in,noLines,G,no_iter)
...
noSkip=0
G=6
getMeanVar(param_filename,mcmc_filenames_in,noLines,noSkip)
